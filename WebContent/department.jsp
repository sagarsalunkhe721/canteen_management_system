<%@page import="com.canteenDB.cms.dto.Department"%>
...
<%
	List<Department> departmentList = (List<Department>) request.getAttribute("ul");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="container-fluid">
		...
		<div class="row d-flex make-center bg-secondary "
			style="height: 55px;">
			<div class="ml-3">
				<a class="btn btn-primary" href="prep_department_form.htm">Add Department</a>
			</div>
			<div class="ml-3">
		...
		<table class="table table-striped table-bordered">
			...
			<tbody>
				...
				<tr class="text-light bg-info">
					...
					<td><a href="delete_department.htm?departmentId=<%=department.getDepartmentId()%>">Delete</a></td>
					<td><a href="select_department.htm?departmentId=<%=department.getDepartmentId()%>">Select</a></td>
				</tr>
				<%
					}
				%>
