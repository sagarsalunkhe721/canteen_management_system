		...
		<div class="row">
			...
			<div class="col-md-6 make-center">
				<div class="bg-info w-50 mt-5 rounded">
					...
					<spr:form action="add_course.htm" commandName="course">
						<div class="make-center mt-2">
							<div>
								<spr:input path="courseName" class="form-control rounded"
									placeholder="Enter Course Name" />
							</div>
						</div>
						<div class="make-center mt-2">
							<div>
								<spr:input path="courseId" class="form-control rounded"
									placeholder="Enter Course Id" />
							</div>
						</div>
						<div class="make-center mt-2">
							<input class="btn btn-success rounded" type="submit"
								value="Add Course" style="width:200px"/>
						</div>
					</spr:form>
